...
/** \file
 * \brief The MMeshInterfaceGridLeafIntersection and MMeshLevelIntersection
 * classes
 */
...
class MMeshInterfaceGridLeafIntersection {
 ...
 public:
  ...
  //! intersection of codimension 1 of this neighbor with element where
  //! iteration started. Here returned element is in LOCAL coordinates of
  //! neighbor
  ...
  //! intersection of codimension 1 of this neighbor with element where
  //! iteration started. Here returned element is in GLOBAL coordinates of the
  //! element where iteration started.
