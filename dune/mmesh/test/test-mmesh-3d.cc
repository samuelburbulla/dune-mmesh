...
template <>
bool compare(const Dune::FieldVector<double, 3>& a,
    ...
    for (auto e : elements(gridView)) {
      ...
      if (elementCount == 0) {
        ...
        checkProperties("face centers",
                        {{e.subEntity<1>(0).geometry().center(),
                          {0.33333333333333331, 0.33333333333333331, 0}},
                         {e.subEntity<1>(1).geometry().center(),
                          {0.5, 0.16666666666666671, 0.33333333333333343}},
                         {e.subEntity<1>(2).geometry().center(),
                          {0.16666666666666666, 0.5, 0.33333333333333331}},
                         {e.subEntity<1>(3).geometry().center(),
                          {0.50000000000000011, 0.5, 0.33333333333333331}}});
        ...
        checkProperties("intersection normals",
                        {{is0.centerUnitOuterNormal(), {0, 0, -1}},
                         {is1.centerUnitOuterNormal(),
                          {0, -0.89442719099991586, 0.44721359549995793}},
                         {is2.centerUnitOuterNormal(),
                          {-0.89442719099991586, 0, 0.44721359549995793}},
                         {is3.centerUnitOuterNormal(),
      ...
      if (elementCount == 1) {
        ...
        checkProperties("index in inside and outside",
                        {{is2.indexInInside(), 2}, {is2.indexInOutside(), 3}});
      }
