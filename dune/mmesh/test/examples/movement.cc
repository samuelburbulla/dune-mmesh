/** \example movement.cc
 * This is an example of how to move the interface within MMesh and get the
 * connected components for mapping data.
 *
...
int main(int argc, char** argv) {
  ...
  try {
    ...
    for (int t = 1; t <= 10; t++) {
      ...
      // write grids
      vtkWriter.write("movement-" + std::to_string(dim) + "d-" +
                      std::to_string(t));
      ivtkWriter.write("movement-" + std::to_string(dim) + "d-interface-" +
                       std::to_string(t));
    }
