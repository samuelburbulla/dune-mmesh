  ...
  try {
    ...
    for (auto e : elements(gridView)) {
      ...
      if (elementCount == 3) {
        ...
        checkProperties("index in inside", {{is0.indexInInside(), 0},
                                            {is1.indexInInside(), 1},
                                            {is2.indexInInside(), 2}});
        ...
        checkProperties(
            ...
            {{neighborA.geometry().center(), {0.5, 0.5, 0.16666666666666666}},
             {neighborB.geometry().center(),
              {0.50000000000000011, 0.5, 0.83333333333333337}}});
        ...
        checkProperties(
            ...
            {{vIdxGlobal1, 3u}, {vIdxGlobal2, 4u}, {vIdxGlobal3, 1u}});
      }
      elementCount++;
    }
