...
//************************************************************************
/*!
 * \brief The MMesh class templatized by the CGAL host grid type and the
 * dimension. \ingroup GridImplementations \ingroup MMesh
 */
template <class HostGrid, int dim>
class MMesh
#ifndef DOXYGEN_SHOULD_SKIP_THIS
    : public GridDefaultImplementation<dim, dim,
                                       double,  ///*FieldType=*/typename
                                                /// HostGrid::Point::R::RT,
...
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
{
 ...
 public:
  ...
  /** \brief Mark elements such that after movement of interface vertices no
   * cell degenerates \param shifts Vector that maps interface vertex index to
   * global coordinate \return If elements have been marked.
   */
  ...
  /** \brief Mark elements such that after movement of vertices no cell
   * degenerates \param shifts Vector that maps vertex index to GlobalCoordinate
   * \return If elements have been marked.
   */
 ...
 public:
  ...
  //! Insert p into the triangulation and add a new interface segment between p
  //! and vertex
 ...
 private:
  ...
  //! Insert a point to the triangulation and connect it to the vertices of the
  ...
  //! Remove a vertex from the triangulation and connect the corresponding
  //! interface elements
