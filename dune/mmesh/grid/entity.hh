...
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
{
 ...
 public:
  ...
  //! Return insertion level (maximal insertionLevel of the corresponding
  //! vertices)
  template <int cd = codim>
  std::enable_if_t<cd != dim, std::size_t> insertionLevel() const {
  ...
  //! Return boundary flag (-1 = not set, 0 = can be removed, 1 = important for
  //! domain boundary)
...
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
{
 ...
 public:
  ...
  //! Geometry of this entity in bounded father entity ( assumption: this
  //! \subset father )
