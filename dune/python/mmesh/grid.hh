...
void registerHierarchicalGrid(pybind11::module module,
                              pybind11::class_<Grid, options...> cls) {
  Dune::Python::registerHierarchicalGrid(module, cls);

  cls.def_property_readonly(
      "bulkGrid",
      [](const Grid &grid) { return grid.getMMesh().leafGridView(); },
      R"doc(
...
void registerHierarchicalGrid(
    pybind11::module module,
    pybind11::class_<Dune::MovingMesh<d>, options...> cls) {
  Dune::Python::registerHierarchicalGrid(module, cls);
  ...
  cls.def_property_readonly(
      ...
      [](const Grid &grid) -> const auto & { return grid.interfaceGrid(); },
  ...
  cls.def(
      ...
      [](Grid &self, const std::vector<FieldVector> &shifts) {
  ...
  cls.def(
      "markElements", [](Grid &self) { return self.markElements(); },
      R"doc(
          Mark all elements in accordance to the default indicator
        )doc");

  cls.def(
      "adapt", [](Grid &self) { self.adapt(); },
      R"doc(
          Adapt the grid
        )doc");
  ...
  cls.def(
      ...
      [](Grid &self, const Element &element) {
  ...
  cls.def(
      "isInterface",
      [](Grid &self, const Intersection &intersection) {
  ...
  cls.def(
      "isInterface",
      [](Grid &self, const Vertex &vertex) { return self.isInterface(vertex); },
      R"doc(
  ...
  cls.def(
      "asIntersection",
      [](Grid &self, const InterfaceEntity &interfaceEntity) {
  ...
  cls.def(
      "addInterface",
      [](Grid &self, const Intersection &intersection,
         const std::size_t marker) { self.addInterface(intersection, marker); },
      R"doc(
          Add the intersection to the set of interface edges and mark it with marker
        )doc");

  cls.def(
      "postAdapt", [](Grid &self) { self.postAdapt(); },
      R"doc(
  ...
  cls.def(
      "isTip",
      [](Grid &self, const InterfaceVertex &interfaceVertex) {
  ...
  cls.def(
      "refineEdge",
      [](Grid &self, const Element &element, const std::size_t edgeIndex,
         const double where) {
  ...
  cls.def(
      "removeVertex",
      [](Grid &self, const InterfaceVertex &vertex) {
        return self.removeVertex(vertex);
      },
      R"doc(
  ...
  cls.def(
      "insertVertexInCell",
      [](Grid &self, const FieldVector &position) {
