...
struct InterfaceIndicator
  ...
  using Base =
      BindableGridFunctionWithSpace<GridPartType, Dune::FieldVector<double, 1>>;
  using SideGeometry = typename GridPartType::GridType::Intersection::
...
template <class BulkGV>
inline static void registerInterfaceIndicator(
    pybind11::module module, pybind11::class_<InterfaceIndicator<BulkGV>> cls) {
  ...
  cls.def_property_readonly(
      "scalar", [](InterfaceIndicator<BulkGV> &self) { return true; });
...
struct Normals : public BindableGridFunctionWithSpace<
                     FemPy::GridPart<InterfaceGV>,
                     Dune::FieldVector<double, InterfaceGV::dimensionworld>> {
  ...
  using Base = BindableGridFunctionWithSpace<GridPartType,
                                             Dune::FieldVector<double, dimw>>;
  using RangeType = typename Base::RangeType;
  ...
  void bind(const typename Base::EntityType &entity) {
    Base::bind(entity);
    normal_ = Base::gridPart()
                  .grid()
                  .getMMesh()
                  .asIntersection(entity)
...
template <class InterfaceGV>
inline static void registerNormals(pybind11::module module,
                                   pybind11::class_<Normals<InterfaceGV>> cls) {
  using pybind11::operator""_a;
  ...
  cls.def_property_readonly("scalar",
                            [](Normals<InterfaceGV> &self) { return false; });
...
struct DistanceFunction
  ...
  DistanceFunction(const GridView &gridView)
      : Base(FemPy::gridPart<GridView>(gridView), "distance", 0),
        interpolation_(GeometryTypes::simplex(dim),
  ...
  void bind(const typename Base::EntityType &entity) {
    ...
    interpolation_ =
        Dune::MultiLinearGeometry<double, dim, 1>(entity.type(), distances);
  }
 ...
 public:
  ...
  void jacobian(const Point &x, typename Base::JacobianRangeType &ret) const {
    ...
    for (std::size_t i = 0; i < dim; ++i) ret[0][i] = jacT[i][0];
  }
...
inline static void registerDistanceFunction(
    pybind11::module module, pybind11::class_<DistanceFunction<GridView>> cls) {
  using pybind11::operator""_a;
  ...
  cls.def_property_readonly(
      "scalar", [](DistanceFunction<GridView> &self) { return true; });
