...
This file includes: interfaceIndicator, normals, distance, domainMarker, interfaceDomainMarker, edgeMovement, interfaceEdgeMovement
"""
...
def normals(igrid):
  ...
  normalsModule = module.Normals(igrid)
  normalsFunction = GridFunction(normalsModule)
  return normalsFunction
...
def distance(grid):
  ...
  distanceModule = module.Distance(grid.hierarchicalGrid.leafView)
  distanceFunction = GridFunction(distanceModule)
