...
from dune.mmesh import _grid2d, _grid3d

# Need to import _interfacegrid modules to ensure Python type is registered.
#pylint: disable=unused-import
from dune.mmesh import _interfacegrid2d, _interfacegrid3d
#pylint: enable=unused-import

logger = logging.getLogger(__name__)

def mmesh(constructor, dimgrid=None, **_parameters):
  ...
  Examples:
    ...
    .. [GR09] C. Geuzaine and J.-F. Remacle. Gmsh: a three-dimensional finite element mesh generator with built-in pre- and post-processing facilities.
    International Journal for Numerical Methods in Engineering 79(11), pp. 1309-1331, 2009.
  ...
  def interfaceGrid(self):
    return self.interfaceHierarchicalGrid.leafView
