...
PYBIND11_MODULE(_utility3d, module) {
  ...
  auto clsNormals =
      Dune::Python::insertClass<Dune::Fem::Normals<
          typename Dune::MovingMesh<3>::InterfaceGrid::LeafGridView> >(
          module, "Normals",
          Dune::Python::GenerateTypeName(
              "Dune::Fem::Normals<typename "
              "Dune::MovingMesh<3>::InterfaceGrid::LeafGridView>"),
          Dune::Python::IncludeFiles{"dune/mmesh/mmesh.hh",
                                     "dune/python/grid/hierarchical.hh",
                                     "dune/python/mmesh/utility.hh"})
          .first;
  ...
  auto clsDistance =
      Dune::Python::insertClass<
          Dune::Fem::Distance<typename Dune::MovingMesh<3>::LeafGridView> >(
          module, "Distance",
