...
{
  // InterfaceIndicator
  auto clsIndicator = Dune::Python::insertClass< Dune::Fem::InterfaceIndicator< typename Dune::MovingMesh<2>::LeafGridView > >(
    module,
    "InterfaceIndicator",
  ...
  // Normals
  auto clsNormals = Dune::Python::insertClass< Dune::Fem::Normals< typename Dune::MovingMesh<2>::InterfaceGrid::LeafGridView > >(
    module,
    "Normals",
  ...
  // Distance
  auto clsDistance = Dune::Python::insertClass< Dune::Fem::Distance< typename Dune::MovingMesh<2>::LeafGridView > >(
    module,
    "Distance",
